...
The archive is 486 records and 487 line drawings — about 900 KB of TypeScript.
...
| Characters          | 326                                                                   |
| Devil fruits        | 120                                                                   |
| Arcs, places, ships | 31 · 7 · 2                                                            |
| Sagas               | 11                                                                    |
| Line drawings       | 487: one per record, and one redrawn from episode 421                 |
| Test files          | 63                                                                    |
| Test cases          | 540                                                                   |
...
- **The archive is not in the bundle.** Moving it behind the loaders took the
  ...
  not all 486. Adding the 120 devil fruits, their drawings and two more pages
