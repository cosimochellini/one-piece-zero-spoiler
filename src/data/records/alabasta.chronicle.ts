  ...
  'portgas-d-ace': [
    ...
    },
    {
      ...
      value: {
        ...
        body: {
          it: 'La vivre card che Ace ha lasciato a [[monkey-d-luffy|Rufy]] si è ridotta a un frammento che brucia. Ad Amazon Lily il giornale spiega il resto: Ace ha perso il duello con [[marshall-d-teach|Barbanera]], è stato consegnato al Governo e sarà giustiziato pubblicamente a Marineford. Rufy legge la data e non esita: non andrà a Marineford, dove il fratello arriverà solo per morire, ma a Impel Down, la prigione dove lo tengono adesso. La carta è la sola prova che Ace è ancora vivo, e continua a rimpicciolire.',
          en: 'The vivre card Ace left with [[monkey-d-luffy|Luffy]] has shrunk to a burning scrap. On Amazon Lily the newspaper explains the rest: Ace lost his duel with [[marshall-d-teach|Blackbeard]], was handed to the Government and will be executed in public at Marineford. Luffy reads the date and does not hesitate: he will not go to Marineford, where his brother will only arrive to die, but to Impel Down, the prison where they hold him now. The card is the one proof that Ace is still alive, and it keeps shrinking.',
        },
      },
    },
    {
