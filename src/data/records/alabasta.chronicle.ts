  ...
  'crocodile': [
    ...
    },
    {
      ...
      value: {
        ...
        body: {
          it: "A Marineford, Sengoku ordina che l'esecuzione proceda non appena le forze di Barbabianca raggiungono la piazza, e i boia alzano le lame su [[portgas-d-ace|Ace]]. Prima che possano calare, un'ondata di sabbia dall'altro capo della piazza li spazza via dalla piattaforma. Crocodile non offre alleanza né scuse: si rifiuta soltanto di lasciare che i marine vincano così a buon mercato, e quando [[donquixote-doflamingo|Doflamingo]] lo deride per l'interferenza, risponde che non si allea con nessuno, tanto meno con Barbabianca. Quali che siano le sue ragioni, un'esecuzione che doveva concludersi in pochi secondi si è appena guadagnata un po' più di tempo.",
