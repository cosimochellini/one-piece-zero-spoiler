...
export const eastBlue: Saga = {
  entries: [
    ...
    // Six East Blue arcs subdivide the saga into finer shelves
    {
      id: 'romance-dawn',
      kind: 'arc',
      revealedAtEpisode: 1,
      ...
      summary: {
        it: 'Un ragazzo di gomma esce da una botte e dice a chiunque lo ascolti che diventerà il Re dei Pirati. Da qui a quattro episodi ha convinto uno spadaccino legato in un cortile che lo ha creduto.',
        en: 'A rubber boy climbs out of a barrel and tells everyone who will listen that he will be King of the Pirates. By four episodes later he has talked a swordsman tied in a yard into believing him.',
      },
      visual: { art: 'romance-dawn', tint: 'red' },
    },
    {
      id: 'orange-town-arc',
      kind: 'arc',
      ...
      summary: {
        it: 'Una cittadina svuotata occupata da un capitano pirata che sa staccarsi i pezzi, una ladra che non vuol dire di essersi unita, e il primo tiro di cannone che manca il bersaglio.',
        en: 'A hollowed town held by a pirate captain who can come apart at the joints, a thief who will not admit she has signed on, and the first cannon shot that misses its mark.',
      },
    ...
    },
    {
      ...
      summary: {
        it: 'Un villaggio dove un ragazzo bugiardo e tre bambini con una bandiera aspettano che i pirati arrivino. Arrivano davvero, e il maggiordomo della villa sulla collina si scopre capitano di una banda di pirati che aspettava il momento giusto da tre anni.',
        en: 'A village where a lying boy and three children with a flag wait for pirates to come. They do arrive, and the butler of the mansion on the hill turns out to be a pirate captain who has been waiting for the right moment for three years.',
      },
      visual: { art: 'syrup-village-arc', tint: 'yellow' },
    },
    {
      id: 'baratie-arc',
      kind: 'arc',
      revealedAtEpisode: 20,
      revealedAtChapter: 42,
      name: { it: 'Baratie', en: 'Baratie' },
      summary: {
        it: 'Un ristorante galleggiante dove il capitano lava i piatti per pagare una finestra sfondatà e il vice-cuoco combatte per la prima volta sotto il sole con le sole gambe. Qui la ciurma vede arrivare qualcosa che non credevano potesse esistere: uno spadaccino più forte.',
        en: 'A floating restaurant where the captain washes dishes to pay for a smashed window and the sous-chef fights for the first time in the sun with only his legs. Here the crew sees something arrive that they did not believe could exist: a stronger swordsman.',
      },
      visual: { art: 'baratie-arc', tint: 'cyan' },
    },
    {
      id: 'arlong-park',
      kind: 'arc',
      ...
      summary: {
        it: 'Un villaggio di pescatori tenuto a tributo da un uomo-pesce che rispetta solo la forza. La navigatrice che ha silenziosamente lasciato la ciurma per una mancia torna con una spada, senza dire a nessuno dove sia andata.',
        en: 'A fishing village held to tribute by a shark fish-man who respects only strength. The navigator who silently left the crew for a pittance comes back with a sword, and says nothing about where she has been.',
      },
    ...
    },
    {
      ...
      summary: {
        it: 'La città dove il Re dei Pirati è stato giustiziato cento anni fa, qui la ciurma vede che il suo capitano vuole diventare quello che quel morto ha promesso. La Marina sa che è qui, e chiude la città per catturarlo.',
        en: 'The town where the King of the Pirates was executed a hundred years ago. Here the crew sees that its captain wants to become what that dead man promised. The Marines know he is here, and close the town to capture him.',
      },
      visual: { art: 'loguetown', tint: 'sand' },
    },
    {
      id: 'monkey-d-luffy',
      kind: 'character',
