  ...
  'sanji': [
    ...
    },
    {
      ...
      value: {
        ...
        body: {
          it: 'Colpito a terra da [[pearl|Pearl]] durante l’assedio al Baratie, Sanji ripensa a quando, ragazzino, cadde in mare durante la tempesta che travolse la nave da crociera appena abbordata, e fu tirato fuori dall’acqua da [[zeff|Zeff]], il capitano pirata che guidava proprio quell’abbordaggio. Naufraghi sullo stesso scoglio spoglio, Zeff gli diede l’unica sacca di cibo, mentendo che la propria conteneva la sua razione; poi si accampò lontano da lui e, da solo, si tagliò una gamba con una roccia per mangiarla piuttosto che morire di fame. Settanta giorni dopo, delirante di fame, Sanji scoprì la verità nella sacca vuota di Zeff e crollò in lacrime.',
          en: 'Knocked down by [[pearl|Pearl]] during the siege of the Baratie, Sanji remembers the boy he was, swept overboard from a raided cruise liner by a sudden storm and pulled from the sea by [[zeff|Zeff]], the pirate captain leading that same raid. Marooned together on a barren rock, Zeff gave him the only food bag, lying that his own held his share; then made camp apart and, alone, cut off his own leg with a rock to eat rather than starve. Seventy days later, delirious with hunger, Sanji found the truth in Zeff’s empty bag and broke down in tears.',
        },
      },
    },
    {
