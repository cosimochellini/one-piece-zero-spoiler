...
| The card burns          |     416 | https://onepiece.fandom.com/wiki/Episode_416 | Second pass: moved from 325, whose outcome is left unrevealed on screen. The defeat is shown in 378, the execution announced in 395, and Luffy learns and chooses Impel Down in 416. A vivre card burns and shrinks; it does not point. |
